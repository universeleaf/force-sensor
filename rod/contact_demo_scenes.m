...
a=struct('id','ceiling_hook','title','弯钩杆向上顶面','lengthMm',200, ...
    ...
    'pushMm',linspace(10,20,12),'tipForceXZ',[1;-1], ...
...
scenes(2).worldRotationYDeg=90; scenes(2).pushMm=linspace(12,21,12);
...
scenes(3).planePointXZ=[0;145]; scenes(3).pushMm=linspace(12,21,12);
...
scenes(4).pushMm=linspace(12,26,12); scenes(4).tipForceXZ=[0.4;-0.4];
...
for j=5:6
    ...
    scenes(j).pushMm=linspace(18,22,12);
end
